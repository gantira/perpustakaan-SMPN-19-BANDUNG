					...
					<div class="card-options">
						<form action="">
							<div class="input-group">
								<a href="{{ route('volume.create') }}" class="btn btn-primary btn-sm">Add</a>
